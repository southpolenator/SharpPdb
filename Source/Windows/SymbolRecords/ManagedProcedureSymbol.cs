...
{
    /// <summary>
    /// Represents managed procedure symbol from the symbols stream.
    /// </summary>
    public class ManagedProcedureSymbol : SymbolRecord
    {
        /// <summary>
        ...
        {
            SymbolRecordKind.S_GMANPROC, SymbolRecordKind.S_LMANPROC
        };
        ...
        /// </summary>
        public ushort ReturnValueRegister { get; private set; }
        ...
        public static ManagedProcedureSymbol Read(IBinaryReader reader, SymbolStream symbolStream, int symbolStreamIndex, SymbolRecordKind kind)
        {
            return new ManagedProcedureSymbol
            {
                ...
                ReturnValueRegister = reader.ReadUshort(),
